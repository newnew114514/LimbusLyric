...
if "LimbusLyric_Setup_1.8.9.137" not in iss: fail.append("Inno output not v1.8.9.136")
...
for token in ("LimbusLyric_Setup_1.8.9.137.exe","LimbusLyric_Portable_1.8.9.137.zip","--packaging-smoke-test","RUN_RELEASE_GATE_SUITE.py","CLEAN_PROJECT_PYTHON_CACHE.py","PYTHONDONTWRITEBYTECODE=1"):
